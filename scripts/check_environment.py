...
EXPECTED_FILES = (
    ...
    "configs/safety/nominal_limits.json",
    ...
    "docs/decisions/0005-independent-safety-supervisor.md",
    "docs/decisions/0006-deterministic-model-mismatch-evaluation.md",
    ...
    "scripts/run_safety_supervisor_demo.py",
    ...
    "src/adaptive_assist/evaluation/__init__.py",
    "src/adaptive_assist/evaluation/config.py",
    "src/adaptive_assist/evaluation/logging.py",
    "src/adaptive_assist/evaluation/robustness.py",
    "src/adaptive_assist/main.py",
    "src/adaptive_assist/py.typed",
    "src/adaptive_assist/safety/__init__.py",
    "src/adaptive_assist/safety/config.py",
    "src/adaptive_assist/safety/supervisor.py",
    ...
    "tests/test_robustness_config.py",
    "tests/test_robustness_evaluation.py",
    "tests/test_robustness_logging.py",
    "tests/test_safety_config.py",
    "tests/test_safety_metrics.py",
    "tests/test_safety_runner_integration.py",
